...
export function CrmEquipeResumo({
  ...
  if (loading) {
    return (
      <div className="animate-pulse rounded-2xl border border-[#1d3a2c] bg-[#0f1d16] p-4">
  ...
  return (
    <section className="rounded-2xl border border-[#1d3a2c] bg-[#0f1d16] p-4 shadow-[0_8px_24px_rgba(0,0,0,0.2)]">
          ...
          {lista.map((a) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-3 rounded-xl border border-[#1d3a2c] bg-[#0f1520] px-3 py-2.5 transition-[border-color,transform] hover:-translate-y-0.5 hover:border-[#c9a24a55]"
              >
