...
export async function PATCH(
  ...
  // bypassa RLS e um financeiro de um tenant flipava o status de contas a pagar de outro tenant.
  ...
  if (error) {
    console.error("[financeiro/contas/pagar PATCH] erro ao atualizar:", error.message);
