        ...
        {success ? (
          <div className="mt-10 rounded-2xl border border-[rgba(63,185,80,0.35)] bg-[rgba(35,134,54,0.12)] p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[var(--obra-texto-2,#8b949e)]">
              Enviamos um e-mail de confirmação para <strong className="text-[var(--obra-texto,#e6edf3)]">{form.owner_email}</strong>.
              Confirme o endereço para activar a sua empresa na plataforma.
            </p>
            <Link
          ...
          <>
            ...
            {step === 1 ? (
              <form onSubmit={onStep1} className="mt-8 flex flex-col gap-5">
                ...
                {msg && (
                  <p role="alert" className="rounded-xl border border-[rgba(248,81,73,0.35)] bg-[rgba(179,38,30,0.08)] px-4 py-3 text-sm text-[#f0aba8]">
                    {msg}
                  </p>
                )}
                <button
