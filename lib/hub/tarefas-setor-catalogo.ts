...
export const TAREFAS_POR_SETOR: Record<SetorAgente, TarefaSetor[]> = {
  atendimento: [
    ...
    { id: "atd-followup-24h", label: "Fazer follow-up em 24h de quem não respondeu" },
    { id: "atd-followup-2tentativas", label: "Insistir até 2 vezes (24h e 72h) antes de desistir" },
    { id: "atd-reativar-sumido", label: "Reativar quem sumiu há alguns dias" },
  ...
  comercial: [
    ...
    { id: "com-lembrar-proposta-vencer", label: "Lembrar o cliente de proposta perto de vencer" },
